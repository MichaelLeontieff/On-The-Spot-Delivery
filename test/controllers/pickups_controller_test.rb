...
class PickupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pickup" do
    assert_difference('Pickup.count') do
      post pickups_url, params: { pickup: { charge: @pickup.charge, collected: @pickup.collected, id: @pickup.id, signature: @pickup.signature } }
    end
  ...
  test "should update pickup" do
    patch pickup_url(@pickup), params: { pickup: { charge: @pickup.charge, collected: @pickup.collected, id: @pickup.id, signature: @pickup.signature } }
