...
class DeliversControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deliver" do
    assert_difference('Deliver.count') do
      post delivers_url, params: { deliver: { id: @deliver.id, package_delivered: @deliver.package_delivered, signature: @deliver.signature } }
    end
  ...
  test "should update deliver" do
    patch deliver_url(@deliver), params: { deliver: { id: @deliver.id, package_delivered: @deliver.package_delivered, signature: @deliver.signature } }
