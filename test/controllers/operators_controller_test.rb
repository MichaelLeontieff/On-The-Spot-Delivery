...
class OperatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operator" do
    assert_difference('Operator.count') do
      post operators_url, params: { operator: { company_email: @operator.company_email, first_name: @operator.first_name, last_name: @operator.last_name, password: @operator.password } }
    end
  ...
  test "should update operator" do
    patch operator_url(@operator), params: { operator: { company_email: @operator.company_email, first_name: @operator.first_name, last_name: @operator.last_name, password: @operator.password } }
