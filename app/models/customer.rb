class Customer < ApplicationRecord
  ...
  validates :card_no, presence: true, length: {minimum: 15, maximum: 16} # Amex has 15 digits and Mastercard and Visa have 16 digits
  validates :card_type, presence: true
  validates :ccv, presence: true, length: {minimum: 3, maximum: 3}
